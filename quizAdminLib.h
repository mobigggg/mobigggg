...
public :
        ...
        void printQuestions()
		{
		   prepareQuizData();
		   printQuestionsList();
		   printQuestionsListhere();
		  cout << "The list has also been stored in SQG-QTNBNKRPT.txt" << endl;
		...
		void printQuestionsList()
		{
		   ...
		   fp = fopen("SQG-QTNBNKRPT.txt", "w" );
			...
			void printQuestionsListhere()
		{
		    int i;
		cout<<"    Question Bank Report      \n";
		cout<<"-------------------------------\n\n";
		    for(i = 0; i < maxQuestions; i++)
		    {
		        {
			       cout<<"Question Category ::"<< quizQuestions[i].qCategory<<endl;
			       cout<<"Question Id       ::"<< quizQuestions[i].qId<<endl;
			        cout<<"Question Text     ::"<<quizQuestions[i].qText<<endl;
			        cout<<"Answer Option 1   :: "<<quizQuestions[i].qAnswer1<<endl;
			         cout<<"Answer Option 2   ::"<<quizQuestions[i].qAnswer2<<endl;
					 cout<<"Answer Option 3   ::"<<quizQuestions[i].qAnswer3<<endl;
					cout<<"Answer Option 4   :: "<<quizQuestions[i].qAnswer4<<endl;
					 cout<<"Correct Option    ::"<< quizQuestions[i].qCAnswer<<endl;
			        cout<<"Allotted Marks    ::"<<quizQuestions[i].qAllottedMarks<<endl;
			        cout<<"-----------------------------------------------------"<<endl;
		        }
		    }
		}
...
public :
   ...
   {  
    ...
    system("cls");
	cout<<"Kindly enter your username & password.\n";
	cout<<"--------------------------------------\n";
    cout << " User Name :: ";
    cin >> usrnm;
    cout << " Password  :: ";
	   ...
	   // Evaluate choices 
	    switch (ch)
	    {
	        ...
	        case 5 :
	        	break;
	        default :
	        	cout>>"Please choose between 1,2,3,4 or 5 .. Press a key to continue.\n";
	        	getch();
		}
	   }
	 }
